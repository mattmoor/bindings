...
type Reconciler struct {
	...
	Lister listers.TwitterBindingLister
}
...
func (r *Reconciler) Reconcile(ctx context.Context, key string) error {
	...
	original, err := r.Lister.TwitterBindings(namespace).Get(name)
...
func (r *Reconciler) reconcile(ctx context.Context, fb *v1alpha1.TwitterBinding) error {
...
func (r *Reconciler) reconcileDeletion(ctx context.Context, fb *v1alpha1.TwitterBinding) error {
